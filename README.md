Aqui está o arquivo `.md` corrigido, com a remoção de todas as barras invertidas de escape e garantindo que as tags HTML funcionem corretamente para a visualização justificada.
